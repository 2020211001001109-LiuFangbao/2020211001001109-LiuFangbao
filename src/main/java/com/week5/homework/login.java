package com.LiuFangbao.week5.homework;
...
public class login extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            String sql = "select * from LiuFangbaotable where username = '"+username+
...
//            ResultSet selected = stmt.executeQuery("select username,password from LiuFangbaotable");
//            boolean ave = false;
